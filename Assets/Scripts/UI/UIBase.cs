...
public class UIBase : MonoBehaviour
{
    ...
    protected void Bind<T>(Type type) where T : UnityEngine.Object
    {
        ...
        {
            // 컴포넌트 찾기
            objects[i] = CheckChild<T>(gameObject, names[i], true);
            if (objects[i] == null)
    ...
    public static T CheckChild<T>(GameObject go, string name = null, bool recuresive = false) where T : UnityEngine.Object
    {
